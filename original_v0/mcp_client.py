...
DEFAULT_MCP_CONNECT_TIMEOUT_SECONDS = float(os.getenv("MCP_CONNECT_TIMEOUT_SECONDS", "10"))
DEFAULT_MCP_TOOL_TIMEOUT_SECONDS = float(os.getenv("MCP_TOOL_TIMEOUT_SECONDS", "30"))
...
class MCPClientManager:
    ...
    async def connect_server(self, name: str, command: str, args: List[str] = None, env: Dict[str, str] = None):
        ...
        if command in ("sse", "http", "url"):
            ...
            url = args[0]
            timeout_seconds = DEFAULT_MCP_CONNECT_TIMEOUT_SECONDS
            transport = None
            last_error = None
    ...
    async def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        ...
        try:
            ...
            logger.warning(
                "[MCPClient] tool call timed out: %s after %.1fs",
                tool_name,
